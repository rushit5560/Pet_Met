    ...
    try {
      ...
      if (isSuccessStatus.value) {
        ...
        instagramController.text =
            getTrainersProfileModel.data.data[0].instagram;
        facebookController.text = getTrainersProfileModel.data.data[0].facebook;

        trainerImage1 = ApiUrl.apiImagePath +
            "asset/uploads/product/" +
            getTrainersProfileModel.data.data[0].image1;
        trainerImage2 = ApiUrl.apiImagePath +
            "asset/uploads/product/" +
            getTrainersProfileModel.data.data[0].image2;
        trainerImage3 = ApiUrl.apiImagePath +
            "asset/uploads/product/" +
            getTrainersProfileModel.data.data[0].image3;
        trainerImage4 = ApiUrl.apiImagePath +
            "asset/uploads/product/" +
            getTrainersProfileModel.data.data[0].image4;
        trainerImage5 = ApiUrl.apiImagePath +
            "asset/uploads/product/" +
            getTrainersProfileModel.data.data[0].image5;
        ...
        if (getTrainersProfileModel.data.data[0].image != "") {
          List<String> profileSplitImageList =
              getTrainersProfileModel.data.data[0].image.split('/');
    ...
    try {
      ...
      if (trainerPictureFile1 != null) {
        ...
        request.files.add(await http.MultipartFile.fromPath(
            "image1", trainerPictureFile1!.path));
      ...
      if (trainerPictureFile2 != null) {
        ...
        request.files.add(await http.MultipartFile.fromPath(
            "image2", trainerPictureFile2!.path));
      ...
      if (trainerPictureFile3 != null) {
        ...
        request.files.add(await http.MultipartFile.fromPath(
            "image3", trainerPictureFile3!.path));
      ...
      if (trainerPictureFile4 != null) {
        ...
        request.files.add(await http.MultipartFile.fromPath(
            "image4", trainerPictureFile4!.path));
      ...
      if (trainerPictureFile5 != null) {
        ...
        request.files.add(await http.MultipartFile.fromPath(
            "image5", trainerPictureFile5!.path));
