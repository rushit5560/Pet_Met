...
class PetMeetingDetailsScreen extends StatelessWidget {
  ...
  final petMeetingDetailsScreenController = Get.put(PetMeetingDetailsScreenController());
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: petMeetingDetailsScreenController.size.height * 0.005.w),
