...
GetPetListModel allRoleProfileModelFromJson(String str) => GetPetListModel.fromJson(json.decode(str));

String allRoleProfileModelToJson(GetPetListModel data) => json.encode(data.toJson());
